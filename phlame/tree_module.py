...
# path_to_nwk_file='Ggreenwoodii/trees/Ggreenwoodii_HKY85_isonames.tre'
# path_to_cmt_file='CMTs/Ggreenwoodii_CMT.pickle.gz'
# path_to_out_tree='Ggreenwoodii/trees/Ggreenwoodii_HKY85_calls_2.tre'
# path_to_out_cladeIDs='Ggreenwoodii/trees/Ggreenwoodii_HKY85_cladeIDs.txt'
...
# intree='trees/Ecoli_GTR_bootstrapped.tre'
# outtree='trees/Ecoli_GTR_bootstrapped_isonames.tre'
# rename_phylip(phylip2names_file, intree, outtree, 
#                   outclustertree=False, rep_CMT_file=False) 

# path_to_candidate_clades='Ggreenwoodii_piotii_HKY85_clades.txt'
