...
def vcf_to_quals_snakemake(path_to_vcf_file,output_path_to_quals,REFGENOMEDIRECTORY):
    ...
    #save
    with open(output_path_to_quals,"wb") as f:
        pickle.dump(quals,f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', type=str, help='Path to input vcf',required=True)
    parser.add_argument('-r', type=str, help='Path to reference genome directory',required=True)
    parser.add_argument('-o', type=str, help='Path to output quals file', required=True)
