...
#%%
# import os
# os.chdir("/Users/evanqu/Dropbox (MIT)/Lieberman Lab/Personal lab notebooks/Evan/1-Projects/strainslicer/dev/combine_positions_py_script")
...
def generate_positions_snakemake(positions_files_list, REFGENOMEDIRECTORY):
    ...
    [chr_starts,genome_length,scaf_names] = genomestats(REFGENOMEDIRECTORY)
...
def ss_combine_positions(path_to_positions_files, path_to_output_p_file, path_to_outgroup_boolean_file, REFGENOMEDIRECTORY):
...
if __name__ == '__main__':
    ...
    ss_combine_positions(args.i,args.o,args.b,args.r)
