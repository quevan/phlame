...
def generate_positions_single_sample(path_to_variant_vcf,path_to_output_positions,maxFQ,REFGENOMEDIRECTORY,outgroup_bool):
    ...
    Args:
        ...
        path_to_output_positions (str): Output path to positions file.
    ...
    if outgroup_bool==True:
        Var_positions=p2chrpos(np.nonzero(include)[0]+1,chr_starts)
...
if __name__ == '__main__':
    ...
    from ss_caller_module import genomestats, p2chrpos
